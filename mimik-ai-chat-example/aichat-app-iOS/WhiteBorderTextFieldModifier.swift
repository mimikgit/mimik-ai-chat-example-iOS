//
//  WhiteBorderTextFieldModifier.swift
//

import Foundation
import SwiftUI

struct WhiteBorderTextFieldModifier: ViewModifier {
...
extension View {
    func textFieldModifier(minWidth: CGFloat = 100, minHeight: CGFloat = 34, borderColor: Color = .gray, lineWidth: CGFloat = 1) -> some View {
        self.modifier(WhiteBorderTextFieldModifier(minWidth: minWidth, minHeight: minHeight, borderColor: borderColor, lineWidth: lineWidth))
    }
}
